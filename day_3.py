...
class Grid:
    def __init__(self, points: Dict[Tuple[int], int] = None, basis=(0, 0)) -> None:
        if points is None:
...
if __name__ == "__main__":
    ...
    second_wire = list(map(lambda x: Instruction(x[0], int(x[1:])), second_wire))
    grid_1 = Grid()
